...
exports.FilesUploadApi = void 0;
var runtime = require("../runtime");
var index_1 = require("../models/index");
/**
 *
 */
var FilesUploadApi = /** @class */ (function (_super) {
    __extends(FilesUploadApi, _super);
    function FilesUploadApi() {
     ...
     * Confirms a file upload
     */
    FilesUploadApi.prototype.confirmFileUpload = function (requestParameters, initOverrides) {
        return __awaiter(this, void 0, void 0, function () {
            var response;
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0: return [4 /*yield*/, this.confirmFileUploadRaw(requestParameters, initOverrides)];
                    case 1:
                        response = _a.sent();
     ...
     * Cria uma nova solicitação de upload de arquivo
     */
    FilesUploadApi.prototype.createFileUpload = function (requestParameters, initOverrides) {
        return __awaiter(this, void 0, void 0, function () {
            var response;
            return __generator(this, function (_a) {
                switch (_a.label) {
