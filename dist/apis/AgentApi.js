...
var AgentApi = /** @class */ (function (_super) {
                ...
                switch (_a.label) {
                    case 0:
                        if (requestParameters['agentRequestBodyDto'] == null) {
                            throw new runtime.RequiredError('agentRequestBodyDto', 'Required parameter "agentRequestBodyDto" was null or undefined when calling reply().');
                        }
                        queryParameters = {};
                        headerParameters = {};
                        headerParameters['Content-Type'] = 'application/json';
                        urlPath = "/internal/agent/reply";
                        return [4 /*yield*/, this.request({
                                path: urlPath,
                                method: 'POST',
                                headers: headerParameters,
                                query: queryParameters,
                                body: (0, index_1.AgentRequestBodyDtoToJSON)(requestParameters['agentRequestBodyDto']),
                            }, initOverrides)];
                    case 1:
                        response = _a.sent();
                        return [2 /*return*/, new runtime.JSONApiResponse(response, function (jsonValue) { return jsonValue.map(index_1.AgentReplyEntityFromJSON); })];
                }
            });
        });
    };
     ...
     * Responde a última mensagem enviada pelo usuário.
     */
    AgentApi.prototype.reply = function (requestParameters, initOverrides) {
        return __awaiter(this, void 0, void 0, function () {
            var response;
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0: return [4 /*yield*/, this.replyRaw(requestParameters, initOverrides)];
                    case 1:
                        response = _a.sent();
                        return [4 /*yield*/, response.value()];
                    case 2: return [2 /*return*/, _a.sent()];
